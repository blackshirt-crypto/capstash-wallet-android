  ...
  return (
    ...
    >
      ...
      <View style={styles.balanceCard}>
        ...
        {/* Wallet identity — only render once address is resolved */}
        {myAddress ? (
        ...
        <Text style={[styles.labelMedium, { marginTop: 18 }]}>
        ...
        return (
          ...
          >
            <View>
              ...
              <Text style={styles.txTime}>{formatTime(tx.time)} · CONF: {tx.confirmations}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  addressLoading:  { ...Typography.micro, color: Colors.greenDim, letterSpacing: 1 },
  labelMedium:     { ...Typography.tiny, color: Colors.greenDim },
